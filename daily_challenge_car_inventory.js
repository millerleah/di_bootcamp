...
// a. loop through the array of object and return the first car with the name “Honda”.
// b. then, return a string in the format This is a {car_make} {car_model} from {car_year}.
...
//   const sentance = `This is a ${firstHonda.car_make} ${firstHonda.car_model} from ${firstHonda.car_year}`;
...
//   const result = carInventory.sort((a, b) =>
//     a.car_year < b.car_year ? -1 : 1
//   );
//   console.log(result);
// }
